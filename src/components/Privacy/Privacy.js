...
const Privacy = () => {
	return (
		<div>
			...
			<p>
				Nur built the Travel Guru app as a Free app. This SERVICE is provided by
				Nur at no cost and is intended for use as is.
			</p>{" "}
			<p>
			...
			<p>
				...
				Terms and Conditions, which is accessible at Travel Guru unless
			...
			<div>
				...
				<p>
					...
					app I want to inform you that whenever you use my Service, in a case
				...
				<p>This policy is effective as of 2020-09-18</p>{" "}
				<p>
					<strong>Contact Us</strong>
				</p>{" "}
				<p>
					If you have any questions or suggestions about my Privacy Policy, do
					not hesitate to contact me at [App contact information].
				</p>
			</div>
		</div>
	);
